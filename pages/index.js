        ...
        <div className="md:w-1/3 flex flex-col items-center justify-center">
          ...
          {hosted_url ? (
            ...
            <a
              ...
              className="mt-20 text-white font-semibold bg-[#1EC7D5] py-3 mx-2 rounded-2xl w-full text-center shadow-2xl hover:bg-red-500 flex items-center justify-center"
            >
              {loading ? (
                <>
                  <svg
